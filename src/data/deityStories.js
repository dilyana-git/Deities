...
export const deityStories = {
  ...
  chaos: {
    ...
    beats: [
      ...
      { label: "The Silence Before the Note", weight: 0.65,
        text: "The Greeks did not imagine Chaos as destruction. The word means simply 'gaping' — the silence before the first note, the blank page before the first word. Even Ovid called it a rude, undivided mass where nothing held its shape." },
  ...
  cronus: {
    ...
    beats: [
      ...
      { label: "Unmanning the Sky", weight: 0.9, figures: ['aphrodite', 'erinyes'],
        text: "He lay in ambush in the folds of dusk, and when the sky descended that night, Cronus reached up and unmanned his father with a single stroke. The foam that gathered around the severed flesh became Aphrodite; the blood on the soil, the Erinyes." },
  ...
  mnemosyne: {
    ...
    beats: [
      ...
      { label: "Nine Nights in Pieria", weight: 1, figures: ['zeus', 'muses'],
        text: "Zeus came to her in Pieria and lay with her for nine nights running. From those nights she bore the nine Muses — Clio for history, Calliope for epic, Melpomene for tragedy, and six more sisters who keep the arts of civilization alive." },
  ...
  hephaestus: {
    ...
    beats: [
      ...
      { label: "Raised by the Sea", weight: 0.7, figures: ['thetis'],
        text: "The sea received what heaven rejected: Thetis and Eurynome drew the broken child from the waves and raised him in an ocean grotto, where for nine years he learned fire and metal, hammering his first wonders in the dark beneath the surf." },
      ...
      { label: "The Bronze Net", weight: 1, figures: ['aphrodite', 'ares'],
        text: "Hephaestus forged a net of bronze links finer than any spider's thread, slung it above his own marriage bed, and hauled the two lovers up for all Olympus to laugh at — proof that craft can shame even the strong and the beautiful." },
  ...
  ares: {
    ...
    beats: [
      ...
      { label: "The Trial on the Hill", weight: 0.8, figures: ['poseidon'],
        text: "When Poseidon's son Halirrhothius assaulted Ares' daughter, the war-god killed him outright and stood trial on a rocky hill above Athens. He was acquitted — and that hill became the Areopagus, his one monument that stood for justice." },
  ...
  dionysus: {
    ...
    beats: [
      { label: "Semele\'s Burning", weight: 0.85, figures: ['semele', 'hera', 'zeus'],
        text: "Jealous Hera tricked the princess Semele into begging Zeus to show himself in his full splendor. Bound by an oath on the Styx, he appeared as he truly was — thunder, lightning, unbearable radiance — and Semele burned to ash where she stood." },
      ...
      { label: "Semele Redeemed", weight: 0.9, figures: ['semele', 'hades'],
        text: "He descended to the underworld for the mother he had never known, brought her back into the light, and raised her to Olympus as the goddess Thyone — the son born from fire returning life to the woman who had burned." },
    ],
  ...
  hades: {
    ...
    beats: [
      ...
      { label: "Orpheus and Eurydice", weight: 0.85,
        text: "Orpheus descended alive, playing his lyre so sweetly that Hades, moved for the only time in all the ages, released Eurydice — on the condition that Orpheus never look back. At the very threshold the singer turned, and she was lost forever." },
  ...
  erinyes: {
    ...
    beats: [
      { label: "Born from Blood", weight: 0.9, figures: ['cronus', 'uranus'],
        text: "When Cronus unmanned his father Uranus, the dark drops that fell upon the Earth quickened into three terrible daughters: Alecto the unceasing, Tisiphone the avenger, and Megaera the jealous. They are older than the Olympians, older than mercy." },
  ...
  // ---- SEA DEITIES ----
  phorcys: {
    story: "Phorcys is an ancient god of the sea's hidden perils — not the open storm but the deeper dangers beneath the surface: the reef that waits unseen, the sucking whirlpool, the dark fathoms where drowned things drift. Grey and crusted like an old rock at the tide-line, he is the deep sea's own grim face.\n\nBorn of Earth and the primordial Sea, he is older than the Olympians by whole ages of the world. Homer calls him 'the Old Man of the Salt Sea,' an elder of the deep who remembers things the younger gods have forgotten. He took his sister Ceto for his wife, and together this old pair bred the most fearsome brood in all the world.\n\nFrom them came the Gorgons with their stone-turning gaze, the grey-born Graeae who share a single eye, the dragon Ladon that guards the golden apples, and the serpents that coil at the edges of things. In some tellings Echidna herself is their daughter, so that even the Mother of Monsters traces her lineage back to this quiet, crusted old god.\n\nPhorcys himself does little in the stories — he is a patriarch, not an actor — but nearly every monster a hero ever faced is, somewhere up the line, a child of his house. The terror that drove the heroes' quests was born of the sea's own still and patient depths.",
    beats: [
      ...
      { label: "Old Man of the Salt Sea", weight: 0.6, figures: ['gaia', 'pontus'],
        text: "Born of Earth and the primordial Sea, he is older than the Olympians by whole ages. Homer calls him 'the Old Man of the Salt Sea,' an elder of the deep who remembers things the younger gods have forgotten." },
      { label: "The Old Pair", weight: 0.85, figures: ['ceto'],
        text: "He took his sister Ceto for his wife, and together this old pair bred the most fearsome brood in all the world." },
      { label: "Father of Every Monster", weight: 1.0, figures: ['medusa', 'graeae', 'ladon', 'echidna'],
        text: "From them came the Gorgons, the grey-born Graeae, the dragon Ladon, and in some tellings Echidna herself — so that even the Mother of Monsters traces her lineage back to this quiet, crusted old god." },
      { label: "The Patriarch", weight: 0.55,
        text: "Phorcys himself does little in the stories — he is a patriarch, not an actor. But nearly every monster a hero ever faced is a child of his house. The terror that drove the heroes' quests was born of the sea's own still and patient depths." },
    ],
    source: "Hesiod, Theogony; Homer, Odyssey XIII."
  },
  ceto: {
    story: "Ceto is the goddess of the sea's monsters and its swallowing deeps — the dread of the great dark shapes that move below a boat, the terror that has no name until it surfaces. Her own name became the Greek word for every whale and sea-beast, so that to speak of a sea-monster at all is, in a way, to speak of her.\n\nA daughter of Pontus and Gaia, she carries the deep ocean's older and darker nature — not the waves a sailor sees, but the things that live beneath them. Sister and wife to the old sea-god Phorcys, she is the womb of horrors at the edge of the world.\n\nFrom her came the Gorgons and the Grey Sisters, and in many tellings the serpent Echidna and the strait-haunting Scylla besides — so that the monsters the heroes were born to slay were very largely the daughters of Ceto. It was also a creature called Cetus — a sea-dragon sharing her name — that was sent to devour Andromeda on her cliff, and that Perseus turned to stone with the Gorgon's head.\n\nShe is the deep ocean understood as a living appetite: calm and lovely from above, and full of teeth below. Where her husband Phorcys is the hidden reef, Ceto is the vast mouth that opens beneath the keel.",
    beats: [
      { label: "The Nameless Terror", weight: 0.75, figures: ['pontus', 'gaia'],
        text: "Ceto is the goddess of the sea's monsters and its swallowing deeps — a daughter of Pontus and Gaia, carrying the deep ocean's older and darker nature. Her own name became the Greek word for every whale and sea-beast." },
      ...
      { label: "The Monster on the Cliff", weight: 0.7, figures: ['andromeda', 'perseus'],
        text: "It was a creature called Cetus — a sea-dragon sharing her name — that was sent to devour Andromeda on her cliff, and that Perseus turned to stone with the Gorgon's head." },
      { label: "Calm Above, Teeth Below", weight: 0.65,
        text: "She is the deep ocean understood as a living appetite: calm and lovely from above, and full of teeth below. Where her husband Phorcys is the hidden reef, Ceto is the vast mouth that opens beneath the keel." },
      { label: "The Daughters of Ceto", weight: 0.6,
        text: "The monsters the heroes were born to slay were very largely her daughters — the terror that drove every quest was born of the deep, and bore her name." },
    ],
    source: "Hesiod, Theogony."
  },
  amphitrite: {
    story: "Amphitrite is the queen of the sea, the calm of the deep waters and the mother of its creatures — a Nereid daughter of the truthful old sea-god Nereus, who reigns over the ocean at the side of Poseidon and lends the waves their gentler moods.\n\nShe did not come to her throne willingly. When Poseidon first desired her, Amphitrite fled his rough courtship to the very ends of the ocean, hiding herself near Atlas at the limits of the world where she believed no one could follow. But the sea-god sent his messengers searching through the waters, and a single dolphin named Delphinus found her in her hiding-place and pleaded his master's cause so sweetly that she relented and let herself be brought back to be made queen.\n\nIn gratitude Poseidon set the dolphin's likeness among the stars — so that a courtship which began in flight ended as a constellation. Together she and Poseidon bore Triton the herald, and she ruled the waves beside her husband as an equal, not a captive — the sea's calm face after Poseidon's storms had passed.\n\nBut she was not always gentle. When Poseidon's eye wandered — as it often did — Amphitrite could be ruthless in her jealousy. When he loved the nymph Scylla, some say it was Amphitrite, not Circe, who poisoned the pool and transformed the girl into the six-headed horror of the strait.",
    beats: [
      ...
      { label: "The Flight to the Deeps", weight: 1.0, figures: ['poseidon'],
        text: "When Poseidon first desired her, Amphitrite fled his rough courtship to the very ends of the ocean. But a single dolphin named Delphinus found her and pleaded his master's cause so sweetly that she relented." },
      ...
      { label: "Mother of Triton", weight: 0.65, figures: ['triton'],
        text: "Together she and Poseidon bore Triton the herald, and she ruled the waves beside her husband as an equal, not a captive — the sea's calm face after Poseidon's storms had passed." },
      { label: "The Queen's Jealousy", weight: 0.75, figures: ['scylla'],
        text: "When Poseidon's eye wandered, Amphitrite could be ruthless — some say it was she, not Circe, who poisoned the pool and transformed the nymph Scylla into the six-headed horror of the strait." },
    ],
    source: "Hesiod, Theogony; Apollodorus, Library."
  },
  triton: {
    story: "Triton is the herald of the sea, the merman son of Poseidon and Amphitrite — a god with the torso of a man and the long scaled tail of a fish, who swims at the head of his father's train through the deep. In his hands he carries a great twisted conch-shell, and that shell is both his voice and his instrument of command.\n\nWhen Triton sets the conch to his lips and blows, the sound rolls out across the water and the waves obey it — climbing into a roar when he wills the sea to rage, or sinking flat and still when he sounds the note of calm. It was his horn, the poets said, that Poseidon had him wind to call the floodwaters back after the great deluge, so that the drowned world might rise again into the light.\n\nHe dwells in a golden palace on the floor of the sea, and when the Argonauts were stranded in the shallows of Lake Tritonis in Libya, it was Triton who appeared and guided their ship back to open water — carrying the whole vessel on his shoulders, some say, through the channels only he could see.\n\nIn later ages the poets imagined not one Triton but many — a whole race of fish-tailed sea-gods blowing conches through the waves, attendants of Poseidon's court. But the first Triton is singular: the sea's announcing trumpet, the sound the ocean makes when it remembers that it has a king.",
    beats: [
      ...
      { label: "Calling Back the Flood", weight: 0.85, figures: ['poseidon'],
        text: "It was his horn that Poseidon had him wind to call the floodwaters back after the great deluge, so that the drowned world might rise again into the light." },
      { label: "The Argonauts in the Shallows", weight: 0.7, figures: ['jason'],
        text: "When the Argonauts were stranded in the shallows of Lake Tritonis, it was Triton who appeared and guided their ship back to open water — carrying the whole vessel on his shoulders through channels only he could see." },
      { label: "The Sea's Announcing Trumpet", weight: 0.55,
        text: "In later ages the poets imagined a whole race of fish-tailed sea-gods blowing conches through the waves. But the first Triton is singular: the sound the ocean makes when it remembers that it has a king." },
    ],
    source: "Hesiod, Theogony; Apollonius of Rhodes, Argonautica."
  },
  nereus: {
    story: "Nereus is the Old Man of the Sea — the eldest and gentlest of the sea-gods, born of Earth and the primordial deep long before Poseidon, and famous above all for two things: he never lies, and he knows what is to come. With his wife Doris he fathered the fifty Nereids, the kindly nymphs of the waves — Thetis and Amphitrite and Galatea among them.\n\nHe is the sea in its oldest and calmest mood, the deep water before the storms came — Hesiod calls him 'unerring and gentle,' the truthful elder who never forgot the ways of justice. But truthful and wise as he is, he yields his knowledge only to those who can take it, for like the sea itself he is a shifter of shapes.\n\nWhen Heracles needed to learn the secret road to the garden of the golden apples, he had to seize the old god and cling on as Nereus turned in his grip to water, to fire, to a roaring beast and a coiling serpent — through form after form — until, finding he could not break free, the Old Man of the Sea returned to himself and told the hero the truth.\n\nHis daughters, the fifty Nereids, are the bright spirits of every calm sea — they ride the crests of the waves on dolphins' backs and come to the aid of sailors in distress. He is the deep's calm conscience: ancient, honest, and not easily held, the sea's memory of what it was before the gods divided it between them.",
    beats: [
      ...
      { label: "Father of the Nereids", weight: 0.65, figures: ['thetis', 'amphitrite'],
        text: "With his wife Doris he fathered the fifty Nereids — Thetis and Amphitrite and Galatea among them — the kindly nymphs of the waves who ride the crests on dolphins' backs and come to the aid of sailors in distress." },
      ...
      { label: "The Deep's Calm Conscience", weight: 0.7,
      ...
      { label: "Before the Gods Divided It", weight: 0.55,
        text: "He is the sea's memory of what it was before the gods divided it between them — gentle, truthful, and older than every storm." },
    ],
    source: "Hesiod, Theogony; Apollodorus, Library."
  },
  proteus: {
    story: "Proteus is the Old Man of the Sea, a shape-shifter who herds the grey seals of Poseidon across the shallows of the Egyptian isle of Pharos. He knows all things — past, present, and the paths that are still to come — but he will not speak unless forced, and forcing him is the trial.\n\nEach noon he rises from the surf, counts his seals like a shepherd counting sheep, and lies down among them to sleep. That is the only moment he can be caught, and whoever seizes him must hold fast through every horror he becomes: a bearded lion, a sinuous serpent, a leopard, a great boar, running water, a towering tree roaring with wind. Only if the grip never loosens will Proteus at last return to his own aged shape and, with a sigh, answer what is asked.\n\nIt was Menelaus, stranded on his long voyage home from Troy, who wrestled the old god down on the advice of Proteus's own daughter Eidothea — and learned at last which winds to court and which gods to appease. She told him to hide among the reeking sealskins until the old man lay down, and to ignore the terrible stench of the pelts and the terrible forms the god would take.\n\nProteus is knowledge that does not want to be known, truth that fights to stay hidden, the sea itself refusing to hold one shape long enough to be read. His name gave the world the word 'protean' — changeable, elusive, endlessly various — the quality of anything that will not be pinned down.",
    beats: [
      ...
      { label: "The Noonday Ambush", weight: 0.65,
        text: "Each noon he rises from the surf, counts his seals like a shepherd counting sheep, and lies down among them to sleep. That is the only moment he can be caught." },
      ...
      { label: "Menelaus on Pharos", weight: 0.85,
        text: "It was Menelaus, stranded on his voyage home from Troy, who wrestled the old god down on the advice of Proteus's own daughter Eidothea — and learned at last which winds to court and which gods to appease." },
      { label: "The Word He Left Behind", weight: 0.55,
        text: "His name gave the world the word 'protean' — changeable, elusive, endlessly various. He is truth that fights to stay hidden, the sea itself refusing to hold one shape long enough to be read." },
    ],
    source: "Homer, Odyssey IV."
  },
  thetis: {
    story: "Thetis is a silver-footed nymph of the sea, gentlest and most loyal of the Nereids, a shape-shifter and a help to the gods in their need — and the mother whose love could not, in the end, save her own son. She stands at the very meeting-point of the divine and the mortal, and pays the price of crossing it.\n\nSo beautiful was Thetis that both Zeus and Poseidon desired her — until it was foretold that she would bear a son greater than his father. At once the gods drew back, and to keep the danger small they married her to a mortal man, Peleus, who had to hold her fast as she changed in his arms to fire and water and beast before she would consent.\n\nTheir wedding feast on Mount Pelion was the last great gathering of gods and mortals together — and the seed of the Trojan War, for it was there that Eris, uninvited, threw the golden apple inscribed 'to the fairest,' and the quarrel of three goddesses began.\n\nTheir son was Achilles, the greatest of warriors and the most short-lived; and Thetis, knowing his doom from the start, tried every way to cheat it — dipping him as an infant in the river Styx to make him invulnerable (but the heel she held him by stayed dry), hiding him among the daughters of Lycomedes, and when even that failed, begging Hephaestus to forge him new armor worthy of a god.\n\nShe could only watch the prophecy close around her child, loving him all the more for being unable to keep him. When the armor came — the shield that held the whole world in its circles — she brought it to him knowing it was the last gift she would ever give.",
    beats: [
      ...
      { label: "Fire and Water and Beast", weight: 0.7,
        text: "Peleus had to hold her fast as she changed in his arms to fire and water and beast before she would consent." },
      { label: "The Wedding That Started a War", weight: 0.75, figures: ['eris'],
        text: "Their wedding feast on Mount Pelion was the last great gathering of gods and mortals — and the seed of the Trojan War, for it was there that Eris, uninvited, threw the golden apple inscribed 'to the fairest.'" },
      { label: "The Dry Heel", weight: 0.8,
        text: "Thetis dipped her infant Achilles in the river Styx to make him invulnerable — but the heel she held him by stayed dry, and that was the spot where the arrow would one day find him." },
      { label: "A Mother's Failing Shield", weight: 1.0, figures: ['hephaestus'],
        text: "When even hiding him from the war failed, she begged Hephaestus to forge him armor worthy of a god — the shield that held the whole world in its circles. She brought it to him knowing it was the last gift she would ever give." },
    ],
    source: "Hesiod, Theogony; Homer, Iliad."
  },
  ...
  perseus: {
    ...
    beats: [
      ...
      { label: "Andromeda Unchained", weight: 0.85, figures: ['andromeda'],
        text: "He found Andromeda chained to a sea-cliff as sacrifice to a monster, turned the beast to stone with the Gorgon's gaze, and won her as his bride. Even the old prophecy came true in the end — gently, by a discus thrown astray, a whole life later." },
    ],
  ...
  heracles: {
    ...
    beats: [
      ...
      { label: "The Twelve Labors", weight: 1.0, figures: ['nemean_lion', 'lernaean_hydra', 'cerberus'],
        text: "Bound to twelve impossible labors, he strangled the Nemean Lion no blade could pierce, cut down the Hydra burning each stump as he severed its heads, and dragged the three-headed hound Cerberus up from the underworld into daylight." },
  ...
  odysseus: {
    ...
    beats: [
      { label: "The Reluctant Warrior", weight: 0.65,
        text: "King of rocky Ithaca, husband of patient Penelope, he feigned madness to dodge the war — ploughing with a donkey, sowing salt — until they set his infant son before the blade and his hand swerved. His cleverness betrayed him into twenty years of wandering." },
      ...
      { label: "The Bow and the Bed", weight: 0.9, figures: ['calypso'],
        text: "Held seven years on Calypso's island, he reached Ithaca as a beggar in rags, strung the great bow no suitor could bend, and sent his arrows through them all. Penelope tested him with the secret of their marriage bed before she let herself believe." },
    ],
  ...
  bellerophon: {
    ...
    beats: [
      ...
      { label: "The Letter of Death", weight: 0.7,
        text: "Before the Chimera, Bellerophon was sent to Lycia bearing a sealed letter that asked the king to kill its bearer. He survived every trial the king devised and won the princess instead — the hero no one else could destroy was destroyed only by himself." },
    ],
  ...
  calypso: {
    ...
    beats: [
      ...
      { label: "The Injustice of the Gods", weight: 0.6, figures: ['zeus'],
        text: "She protested to Hermes that the gods were hypocrites — they took mortal lovers freely but punished any goddess who did the same. She was right, and the gods sent the order anyway." },
      { label: "The Shore After", weight: 0.55,
        text: "Calypso remained on her island after he left, immortal and alone again, the hidden one with no one left to hide. The sea she watched him cross was the same sea forever." },
    ],
  ...
  muses: {
    ...
    beats: [
      ...
      { label: "The Singer's Invocation", weight: 0.6,
        text: "This is why the old poems all begin by calling upon them: no singer believed the song was truly his own, but rather that the Muses, the daughters of Memory, were speaking the remembered past through his mouth." },
      { label: "The Nine Arts", weight: 0.55,
        text: "Each Muse governs her own province — Calliope the epic, Clio history, Melpomene tragedy, Thalia comedy — and together they hold between them every art that mortals have ever practiced or dreamed." },
    ],
    source: "Hesiod, Theogony."
  },
  daphne: {
    ...
    beats: [
      ...
      { label: "The Crown of Every Victor", weight: 0.65, figures: ['apollo'],
        text: "Apollo pressed his face to the cool bark where her heart still beat beneath it, and made the laurel his own forever — so that the girl who fled him would crown his every victory, and the wreath of triumph would always be a memory of loss." },
      { label: "The River's Daughter", weight: 0.55,
        text: "She had cried out to her father, the river-god Peneus, to destroy the beauty that doomed her. He answered the only way a father could — not by saving her, but by changing what she was." },
    ],
  ...
  io: {
    ...
    beats: [
      ...
      { label: "The Strait That Bears Her Name", weight: 0.6,
        text: "Driven by the gadfly, she swam the strait between Europe and Asia that ever after bore her name — the Bosporus, the 'ox-ford,' named for a girl who had never asked to be anything but herself." },
      { label: "The Hundred Eyes of Argus", weight: 0.65,
        text: "When Argus was killed, Hera took his hundred eyes and set them in the tail of the peacock — so that the guardian who had failed her still watches, from every feather, with unblinking grief." },
    ],
    source: "Ovid, Metamorphoses I; Aeschylus, Prometheus Bound. Further reading: Ted Hughes, Tales from Ovid."
  },
  callisto: {
    ...
    beats: [
      ...
      { label: "Never Permitted to Rest", weight: 0.65, figures: ['hera'],
        text: "By Hera's lasting grudge, the Great Bear and the Little Bear are never permitted to sink beneath the horizon and bathe in the sea — circumpolar, restless, denied even the ocean's rest that every other constellation knows." },
      { label: "The Huntress Who Became the Hunted", weight: 0.55,
        text: "She who had run the forests with her bow became the quarry — fleeing the very hounds that had once run at her side, the huntress turned prey by the jealousy of those who should have protected her." },
    ],
  ...
  arachne: {
    ...
    beats: [
      ...
      { label: "The Old Woman's Warning", weight: 0.6,
        text: "Before the contest, Athena came disguised as an old woman to counsel humility. Arachne scorned her for it — 'let the goddess come herself and compete, if she dares.' The goddess threw off the disguise, and the looms were set." },
      { label: "The Tapestry of Truth", weight: 0.7,
        text: "Arachne's tapestry showed the gods at their worst — Zeus as a bull, as a swan, as a shower of gold, every disguise a seduction. The work was flawless. That was the crime: that a mortal had woven the truth more beautifully than a goddess could weave a lie." },
    ],
  ...
  asclepius: {
    ...
    beats: [
      ...
      { label: "The Rod of Asclepius", weight: 0.6,
        text: "His emblem is a single serpent coiled around a staff — the rod of Asclepius, which stands to this day as the sign of medicine and healing across the world. The snake, which sheds its skin and renews itself, is life returning from the edge of death." },
      { label: "Temples of Healing Sleep", weight: 0.65,
        text: "His temples at Epidaurus and Cos became the great healing centers of the ancient world. The sick came to sleep in his sanctuary, and in their dreams the god appeared and told them their cure — medicine as revelation, delivered in the language of sleep." },
    ],
  ...
  minotaur: {
    ...
    beats: [
      ...
      { label: "The Tribute of Flesh", weight: 0.7,
        text: "Every nine years Athens was forced to send seven youths and seven maidens into the Labyrinth as tribute — living offerings swallowed by the dark, their screams lost in the windings." },
      { label: "Neither Man Nor Bull", weight: 0.6,
        text: "The Minotaur is the shame of its own existence — the body of a man and the head of a beast, hunger without reason, a creature that should never have been and could never be anything but what it was." },
    ],
  ...
  ariadne: {
    ...
    beats: [
      ...
      { label: "The Thread and the Betrayal", weight: 0.7, figures: ['theseus'],
        text: "She had betrayed her own father and her own blood for Theseus's sake — given him the thread that saved his life, the sword that killed her half-brother — and he repaid her by sailing away while she slept." },
      { label: "The Crown That Shines Still", weight: 0.6,
        text: "The Corona Borealis is Ariadne's crown, set among the stars by the god who loved what the hero discarded — the brightest circlet in the northern sky, a wedding gift that outlasted every kingdom." },
    ],
    source: "Apollodorus, Library; Ovid, Metamorphoses VIII."
  },
  medea: {
    ...
    beats: [
      ...
      { label: "The Brother She Killed", weight: 0.7,
        text: "Fleeing Colchis, she had cut her own brother to pieces and scattered him across the sea so her father's ships would stop to gather the remains — the first proof that her devotion and her cruelty ran in the same channel." },
      { label: "Granddaughter of the Sun", weight: 0.6, figures: ['helios', 'hecate'],
        text: "She was a granddaughter of Helios and a priestess of Hecate — sorcery and sunlight in one blood. The chariot that bore her away from Corinth was drawn by winged serpents sent by her grandfather, the Sun himself rising to save his own." },
    ],
   ...
   semele: {
    ...
    beats: [
      ...
      { label: "The Unbreakable Oath", weight: 0.75,
        text: "Zeus had sworn by the waters of Styx to grant whatever Semele asked — the one oath even gods cannot break. When she asked for his true form, he could not refuse, and the love that bound him became the instrument of her destruction." },
      { label: "Set Among the Stars", weight: 0.6,
        text: "Dionysus descended to the underworld to reclaim her and brought her up to Olympus under the name Thyone — the mortal who died of divinity made divine at last, the only mother of a god to join the gods herself." },
    ],
    source: "Ovid, Metamorphoses III; Apollodorus, Library. Further reading: Ted Hughes, Tales from Ovid."
  },
  phaethon: {
    ...
    beats: [
      ...
      { label: "The Scorched Earth", weight: 0.65,
        text: "Where the chariot plunged too low, the rivers boiled and the mountains cracked and whole peoples were scorched to darkness — the Sahara, the poets said, was the scar the sun-chariot left when a boy held the reins." },
      { label: "The Grieving Father", weight: 0.7, figures: ['helios'],
        text: "Helios, who had sworn the rash oath and could not take it back, veiled his face in grief and refused to drive the chariot for a whole day after — so that the world knew one day of total darkness, lit only by the burning of the earth." },
    ],
  ...
  narcissus: {
    ...
    beats: [
      ...
      { label: "Echo's Unanswered Love", weight: 0.7, figures: ['echo'],
        text: "The nymph Echo loved him and trailed him through the woods aching to call out — but could only return his own words, until he turned from her in scorn. She wasted away until nothing remained but her voice, still answering from the hills." },
      { label: "The Pool of Self-Knowledge", weight: 0.55,
        text: "The prophet Tiresias had foretold that Narcissus would live to a great age 'if he never comes to know himself.' The pool was the mirror that fulfilled the prophecy — self-knowledge, delivered as self-destruction." },
    ],
  ...
  echo: {
    ...
    beats: [
      ...
      { label: "The Cover for Zeus", weight: 0.65, figures: ['hera', 'zeus'],
        text: "She had angered Hera by covering for Zeus's infidelities with her endless chatter — holding the goddess in conversation while the god's lovers slipped quietly away. So Hera took from her all speech of her own, leaving only the echo." },
      { label: "A Love That Can Only Answer", weight: 0.55,
        text: "Echo is the cruelest kind of longing — a love that can never speak first, never say anything new, only give back what it is given. 'Come to me,' he called, and 'to me' was all she could answer." },
    ],
    source: "Ovid, Metamorphoses III. Further reading: Ted Hughes, Tales from Ovid."
  },
  actaeon: {
    ...
    beats: [
      ...
      { label: "Ruin Without Fault", weight: 0.65,
        text: "His is the most frightening kind of tragedy: ruin with no fault in it. He was not proud, not boastful, not defiant — merely in the wrong place at the wrong hour, and for that the goddess ended him." },
      { label: "The Hounds' Names", weight: 0.6,
        text: "Ovid names each of the fifty hounds by name — Blackfoot, Tracker, Hurricane, Tigress — as they tear him apart. It is the cruelest list in all the myths: each name a loyalty that no longer recognized its master." },
    ],
    source: "Ovid, Metamorphoses III. Further reading: Ted Hughes, Tales from Ovid."
  },
  tiresias: {
    ...
    beats: [
      ...
      { label: "Prophet of Thebes", weight: 0.7, figures: ['oedipus'],
        text: "It was Tiresias who told Oedipus the truth he did not want to hear — that the murderer he sought was himself. The blind man saw what the man with eyes could not, and was cursed for speaking it." },
      { label: "A Voice Among the Dead", weight: 0.6, figures: ['odysseus'],
        text: "Even in death he kept his prophetic mind. When Odysseus opened a trench to the underworld, it was Tiresias's shade who rose to drink the dark blood and foretell the hero's homecoming — the one ghost in the underworld who still remembered the future." },
    ],
    source: "Ovid, Metamorphoses III; Homer, Odyssey XI. Further reading: Ted Hughes, Tales from Ovid."
  },
  adonis: {
    ...
    beats: [
      ...
      { label: "A Descent Like Persephone's", weight: 0.65, figures: ['persephone'],
        text: "Like Persephone, Adonis descends and returns — part of the year in the world above, part below. He is the cycle of the seasons written in a love story, the beauty that dies with the harvest and returns with the spring." },
      { label: "The Jealous God", weight: 0.6, figures: ['ares'],
        text: "Some say it was Ares, Aphrodite's jealous lover, who sent the boar — or even took the boar's shape himself. If so, the beauty the world could not keep was destroyed by the god of war, envious of a mortal boy." },
    ],
  ...
  hermaphroditus: {
    ...
    beats: [
      ...
      { label: "Neither and Both", weight: 0.65,
        text: "The fused being was neither wholly male nor wholly female but both at once — a new thing in the world, a body that held two selves past any separating." },
      { label: "A Prayer Answered Too Well", weight: 0.55,
        text: "Salmacis got exactly what she asked for — to never be parted from Hermaphroditus. The gods granted it with terrible exactness, as gods always do: the prayer fulfilled is the punishment delivered." },
    ],
  ...
  salmacis: {
    ...
    beats: [
      ...
      { label: "The Nymph Unlike Her Sisters", weight: 0.55, figures: ['artemis'],
        text: "She was the one naiad who would not hunt, would not run with Artemis's band — she loved only her own reflection and her own stillness, until a beauty greater than her own walked into her pool." },
      { label: "The Softening Waters", weight: 0.6,
        text: "Hermaphroditus begged that whoever bathed in Salmacis's pool should be softened as he had been. The spring kept its strange power — Salmacis's name surviving only as the enchantment she had become." },
    ],
    source: "Ovid, Metamorphoses IV. Further reading: Ted Hughes, Tales from Ovid."
  },
  ...
  hemera: {
    ...
    beats: [
      ...
      { label: "Gentle and Constant", weight: 0.5,
        text: "Hemera is not the sun — she is the soft pervading brightness between one dawn and the next, the quality of the air when the light is in it. She is the world's first and simplest gift: the ability to see." },
      { label: "Sister of Aether", weight: 0.55, figures: ['aether'],
        text: "Born alongside her brother Aether, the bright upper air, Day and clear sky came into the world together out of the deepest dark — light as the offspring of darkness, the first paradox." },
    ],
    source: "Hesiod, Theogony."
  },
  aether: {
    ...
    beats: [
      ...
      { label: "Brother of Day", weight: 0.55, figures: ['hemera'],
        text: "Born alongside his sister Hemera the Day, Aether and light came into the world together — the upper sky and the lower brightness, two gifts of clarity from the same dark womb." },
      { label: "Above All Weather", weight: 0.5,
        text: "No cloud reaches the aether, no storm troubles it. It is the calm radiance the Greeks imagined the immortals dwelt within — the sky above the sky, serene and untroubled by anything that happens below." },
    ],
    source: "Hesiod, Theogony."
  },
  epimetheus: {
    ...
    beats: [
      ...
      { label: "Hope Shut Inside", weight: 0.7,
        text: "Of all the evils that flew from the jar, only Hope remained — shut inside at the last instant before the lid came down. Whether that makes Hope a comfort or just one more cruelty the myths have never decided." },
      { label: "Twice the Cost", weight: 0.6, figures: ['prometheus'],
        text: "Twice his afterthought cost humankind dearly. He is the proof that good intentions, without foresight, can undo a world — the slow brother who makes the mess the clever brother must clean up." },
    ],
    source: "Hesiod, Theogony; Works and Days."
  },
  styx: {
    ...
    beats: [
      ...
      { label: "Victory, Strength, Power, Zeal", weight: 0.65,
        text: "Her children are Nike the Victory, Kratos the Strength, Bia the Power, and Zelus the Zeal — the four forces that win every war, and all of them fought for Zeus at the very beginning." },
      { label: "The River Seven Times Round", weight: 0.6,
        text: "Styx winds seven times around the realm of the dead, a cold black current that no living thing can cross and no dead thing can return from — the boundary not even gods would touch lightly." },
    ],
    source: "Hesiod, Theogony."
  },
  leto: {
    ...
    beats: [
      ...
      { label: "Delos Made Holy", weight: 0.65,
        text: "The barren floating island of Delos, her one refuge, was fixed forever in the sea and made holy — the most sacred ground in all the Aegean, where no one was permitted to be born or to die." },
      { label: "The Gentle Titaness", weight: 0.55, figures: ['zeus'],
        text: "Leto is the quiet one among the Titans — she asked for little and was hunted across the world for it. Her whole story is the cost and the triumph of bearing the children of the most powerful god." },
    ],
  ...
  polyphemus: {
    ...
    beats: [
      ...
      { label: "The Lovesick Giant", weight: 0.55,
        text: "In gentler tellings the Cyclops loved the sea-nymph Galatea with a clumsy tenderness, singing to her from the clifftops and bringing her wild gifts. But she loved the youth Acis, and the giant crushed him beneath a boulder in his jealousy." },
  ...
  alcmene: {
    ...
    beats: [
      ...
      { label: "The Long Night", weight: 0.6, figures: ['zeus'],
        text: "Zeus lengthened the night of Heracles' conception to three times its natural span, holding back the dawn itself. Amphitryon returned the next day and knew nothing — and the twin births that followed bore one mortal child and one half-divine." },
  ...
  humanity: {
    ...
    beats: [
      ...
      { label: "The Trick at Mecone", weight: 0.65, figures: ['prometheus', 'zeus'],
        text: "At Mecone, Prometheus divided an ox and invited Zeus to choose — one heap of gleaming fat hiding bare bones, the other of scraps hiding the best meat. Zeus chose the fat and was tricked, and the anger of that trick shaped everything that followed." },
    ],
  ...
  daedalus: {
    ...
    beats: [
      ...
      { label: "Refuge in Sicily", weight: 0.55,
        text: "After Icarus fell, Daedalus flew on alone to Sicily and built marvels for King Cocalus. When Minos pursued him there, the women of the court killed the Cretan king with boiling water — the craftsman's last protectors finishing what his genius could not." },
    ],
  ...
  icarus: {
    ...
    beats: [
      ...
      { label: "The Burial", weight: 0.55,
        text: "A partridge watched from a low branch as Daedalus buried his son on the island that would bear the boy's name — and clapped its wings in satisfaction, remembering its own fall. Even grief, Ovid says, was shadowed by an older crime." },
    ],
  ...
  // ---- THE ILIAD ----
  achilles: {
    story: "His mother was a goddess of the sea and his father a mortal man, and so Achilles was born into the exact seam of the world where immortality fails. Thetis, they say, held him by one heel and dipped him in the black water of the Styx to burn the mortality out of him — but the heel her fingers covered never touched the river, and in that unwashed handsbreadth his whole death was already waiting.\n\nHe came to Troy knowing a prophecy: that he might live long and be forgotten, or die young at Troy and be sung forever. He chose the song. But the Iliad is not really about that choice — it is about a quarrel. Agamemnon, the high king, took from Achilles a captive girl, Briseis, to salve his own wounded pride, and Achilles, insulted past bearing, withdrew to his tents and let the Greeks be slaughtered until the king should learn what he was worth.\n\nHe would not have returned for honor, or for gold, or for the whole ruin of the army. He returned for grief. When his beloved Patroclus went out in Achilles' own armor and was killed by Hector, something in Achilles broke open into a rage that frightened even the gods. He hunted Hector down beneath the walls, killed him, and dragged the body behind his chariot day after day until an old king came weeping to buy it back.\n\nThat old king, Priam, kneeling to kiss the hands that had killed his son, is the still point the whole poem turns toward — for in him Achilles finally sees his own father, and his own coming death, and the two enemies weep together. Achilles is the most terrible and the most human of the heroes: a man who knows exactly how little time he has, and spends it all on wrath and love.",
    source: "Homer, Iliad."
  },
  patroclus: {
    story: "Of all the men at Troy, Patroclus was the gentle one — the one who took the captive women aside and spoke kindly to them, the one whose tent the wounded came to. He had been given to Achilles' household as a boy and grew up at his side, older than Achilles in years but always the softer heart of the pair, dearest to him of all living men.\n\nWhen Achilles in his wrath let the Greeks be driven back to their burning ships, it was Patroclus who could not bear it. He begged to be allowed to wear Achilles' armor and lead the fresh troops out, so that the Trojans might think Achilles himself had returned and lose their nerve. Achilles agreed — but warned him: drive them from the ships, and no further. Do not chase them to the walls.\n\nHe chased them to the walls. Glory took him, as it takes them all, and he forgot the warning. Beneath the towers of Troy the god Apollo struck the helmet from his head and loosened the armor on his back, and while he stood dazed a Trojan spear found him, and then Hector finished him. Even dying, Patroclus told Hector the truth: that he too would soon be dead.\n\nHis death is the hinge of the Iliad. It is the loss that drags Achilles back into the war and so, by the chain of vengeance, back toward his own end. The two of them are burned in the same fire in the end, and Achilles asks that their ashes be mingled in a single urn, so that not even death should tell them apart.",
    source: "Homer, Iliad."
  },
  hector: {
    story: "If Achilles is the glory of the Iliad, Hector is its heart. He is the eldest son of Priam and the one man holding Troy together, and unlike the Greek heroes he did not come to this war for plunder or fame — he fights because behind him stand his father's city, his wife, and a baby son, and there is no one else to stand between them and the sea of Greek spears.\n\nHomer gives him the poem's tenderest scene. Andromache finds him at the Scaean Gate and begs him not to go back out, for she has already lost father and brothers and he is now father, mother, and husband all at once to her. Hector answers that he cannot hide behind the walls while others die; he would die of shame. Then he reaches for his baby — and the child screams, terrified by the horsehair crest of his war-helmet, and the parents laugh through their fear, and Hector lifts the helmet off and prays that his son may one day be called greater than his father.\n\nHe knows Troy will fall. He says so plainly. He fights anyway. When he kills Patroclus, he seals his own doom, for now Achilles is coming, and Hector alone waits outside the gates to meet him while his people watch from the walls. At the last his nerve fails and he runs; three times around the city they race before he turns to fight and dies.\n\nAchilles dishonors the body, dragging it in the dust, but the gods preserve it, and in the end Priam ransoms it and Troy mourns. The Iliad does not end with the fall of the city or the death of Achilles. It ends with the funeral of Hector — the man who lost, given the last word.",
    source: "Homer, Iliad."
  },
  ajax: {
    story: "Ajax the son of Telamon was the largest of the Greeks and, after Achilles, the strongest — a wall of a man who carried a shield like a tower, seven layers of oxhide faced with bronze. Where the other heroes had gods whispering at their shoulders, Ajax fought almost alone, without divine favor, on nothing but his own enormous, stubborn strength. When the Trojans stormed the ships with fire, it was Ajax who stood on the decks and held them off with a great pike, giving ground one plank at a time.\n\nHe fought Hector in single combat once, all afternoon, until the heralds parted them at nightfall and the two enemies exchanged gifts in mutual respect. He was the shield of the army, the man you put in the gap in the line.\n\nBut the greatest strength is not the same as the greatest cunning, and that undid him. When Achilles died, his divine armor was to be awarded to the best of the remaining Greeks — and the leaders gave it not to Ajax, who had carried Achilles' very body from the field, but to Odysseus, whose weapon was his tongue. The shame of it turned in him like poison. That night Athena sent a madness on him; thinking he was slaughtering the leaders who had wronged him, he fell instead upon the army's cattle, hacking them to pieces in the dark.\n\nWhen the madness lifted and he saw what he had done — the great warrior standing bloody among dead beasts, a figure of ruin — the shame was worse than the grief. He fixed his sword upright in the ground and fell upon it. The mightiest defender of the Greeks was killed by no Trojan, but by his own hand and his own honor.",
    source: "Homer, Iliad; Sophocles, Ajax."
  },
  diomedes: {
    story: "Diomedes was young, and brave, and — rarest of all among these men — sensible. He did not sulk like Achilles or bluster like Agamemnon; when the high king insulted him he swallowed it and fought the harder. Athena loved him for it, and on his great day she poured strength into him and lifted the mist from his eyes so that he could tell god from man on the battlefield, warning him to fight any immortal he met save Aphrodite alone.\n\nSo he raged through the Trojan ranks, and when the goddess Aphrodite came down to rescue her mortal son Aeneas from him, Diomedes did the unthinkable — he chased a goddess and drove his spear through her delicate wrist, and she fled shrieking to Olympus to weep in her mother's lap, while the Greeks laughed. It is one of the strangest, most audacious moments in all of Homer: a mortal drawing the golden blood of the deathless ones.\n\nAnd he was not finished. When Ares himself, the very god of war, waded into the fighting on the Trojan side, Athena climbed into Diomedes' chariot, seized the reins, and guided his spear into the god's belly. Ares bellowed with the noise of ten thousand men and fled the field.\n\nYet Diomedes could also be gracious. Meeting the Trojan Glaucus in the lines, he discovered their grandfathers had been guest-friends, and rather than fight he exchanged armor with his enemy in the middle of the war — trading his bronze for Glaucus's gold, and thinking the bargain well worth the courtesy. He is the hero who shows that valor and good sense need not be enemies.",
    source: "Homer, Iliad."
  },
  agamemnon: {
    story: "Someone had to lead the thousand ships, and it fell to Agamemnon, king of golden Mycenae, brother of the wronged Menelaus and the most powerful lord in Greece. He was a king in the fullest and worst sense — magnificent, proud, and unable to imagine that his own pride might cost other men their lives.\n\nHe began the war with a wound to his own house. Becalmed at Aulis, the fleet unable to sail, he was told the goddess Artemis demanded the life of his daughter Iphigenia — and he gave her, and the winds came. He would spend the rest of the tale, and his death, paying for that morning.\n\nAt Troy his pride nearly lost everything. Forced to give up his own captive girl, he seized Achilles' prize Briseis to save face, and so drove the best of his warriors out of the war and the Greeks to the edge of destruction. Homer does not spare him: he is often afraid, often wrong, quick to despair and quicker to blame. But he is not a coward on the field, and there are moments the crown sits well on him.\n\nHis true doom waited at home. Ten years he was away, and in those years his wife Clytemnestra — who had never forgiven the killing of their daughter — took a lover and laid her plans. Agamemnon came home in triumph, walked into his own palace across a path of crimson cloth, and was cut down in his bath like an ox at the manger. The lord of men, who had commanded all of Greece, could not command his own threshold.",
    source: "Homer, Iliad; Aeschylus, Agamemnon."
  },
  menelaus: {
    story: "Menelaus is the reason for all of it — or rather, his wife is. King of Sparta and younger brother of Agamemnon, he had married Helen, the most beautiful woman in the world, and for a while he was the most fortunate of men. Then a guest under his own roof, the Trojan prince Paris, carried her away across the sea, and the whole vast machinery of the war ground into motion to bring her back.\n\nHe is not the greatest of the Greek fighters, but he is steady and decent, and Homer clearly likes him. Given the chance to end the war by single combat, he faced Paris between the two armies — the wronged husband against the man who had taken his wife — and he was winning, dragging Paris by the helmet-strap toward the Greek lines, when Aphrodite snapped the strap and whisked her favorite away in a cloud, cheating him of his revenge.\n\nHe fought on through all the years of it, was wounded, guarded the body of Patroclus, held his place in the line. He wanted, more than glory, simply to have his life back — his wife, his hall, his peace.\n\nAnd in the end, alone of the great Greek causes, his story comes out gently. When Troy fell he found Helen again, and though he had sworn to kill her, the sight of her undid his anger. He took her home to Sparta, and there — the Odyssey shows us — they are living still, an old married couple among their treasures, the war a long strange grief behind them, telling the wandering Telemachus stories of his lost father.",
    source: "Homer, Iliad; Homer, Odyssey."
  },
  priam: {
    story: "Priam had fifty sons, and a city that had stood for generations, and a long life behind him, and he lived to watch nearly all of it destroyed. He is the old king of Troy, too aged now to fight, who must stand on the walls and watch his sons go out one by one to die on the plain below.\n\nHomer gives him one unforgettable act. After Achilles has killed Hector and dragged his body in the dust for days, refusing all burial, it is Priam — not a soldier, not a god, an old man alone — who does the bravest thing in the poem. Guided by Hermes through the enemy lines at night, he walks into the tent of the man who has slaughtered his sons, kneels, and kisses those terrible hands, and begs for the body of his boy.\n\nAnd the miracle of the scene is that it works — not by force but by grief. Achilles looks at this weeping old man and sees his own father, far away, who will soon mourn him too, and the killer and the bereaved father weep together in the firelight, each for his own dead. Achilles gives the body back, and grants a truce for the funeral.\n\nBut the reprieve is only that. Troy falls not long after, and Priam's own death is the emblem of the city's: cut down by Achilles' son at the altar of Zeus in his own courtyard, an old king murdered at the one place that should have been sanctuary. He is the image of everything war takes — not the young glory of it, but the old grief left behind.",
    source: "Homer, Iliad; Virgil, Aeneid II."
  },
  paris: {
    story: "The ruin of Troy began with a beauty contest. Three goddesses — Hera, Athena, Aphrodite — quarreled over a golden apple marked for the fairest, and Zeus, too wise to judge between them, sent them down to a shepherd on Mount Ida to decide. The shepherd was Paris, secretly a prince of Troy, exposed at birth because a prophecy said he would burn the city down.\n\nEach goddess offered him a bribe. Hera offered power, Athena wisdom and victory in war. Aphrodite offered him the most beautiful woman in the world. He gave her the apple, and so chose desire over power and over wisdom — and doomed his city, exactly as the prophecy had promised.\n\nThe woman was Helen, and she was already married, to Menelaus of Sparta. Paris sailed as a guest, and sailed home with his host's wife, and behind him came a thousand ships. He was a charming man and a beautiful one, better in the bedchamber than the battlefield; his own brother Hector rebukes him bitterly for hiding from the war he started. In single combat with Menelaus he had to be rescued by Aphrodite from certain death.\n\nAnd yet it was Paris, the lover and not the warrior, who killed the greatest warrior of them all. With Apollo guiding the shaft, he loosed the arrow that struck Achilles in his one mortal point, the heel, and brought the invincible man down. Paris did not live to see Troy fall — he died of a poisoned arrow before the end — but the fire the prophets had foreseen in him consumed the city all the same.",
    source: "Homer, Iliad; Apollodorus, Library; Ovid, Heroides."
  },
  helen: {
    story: "She was the daughter of Zeus, hatched — some say — from an egg, after the god came to her mother Leda in the form of a swan; and she was so beautiful that beauty became her fate and her prison. Every king in Greece had wanted to marry her, and to keep the peace they had all sworn an oath: whoever won her, the rest would defend. So when Paris took her to Troy, the oath called up the thousand ships, and the whole Greek world went to war over one woman's face.\n\nWhat is remarkable in Homer is how little he blames her, and how much she blames herself. She sits at her loom in Troy weaving the very battles being fought for her sake; she stands on the walls and names the Greek captains for old Priam, and everywhere she goes she calls herself a shameless thing, a cause of grief, wishing she had died before she ever came there. Whether she fled with Paris willingly or was carried by the compulsion of Aphrodite, Homer leaves uneasy and unclear — perhaps because Helen herself no longer knows.\n\nShe is caught between worlds: too beautiful to be left alone, too aware to enjoy the war fought in her name. When Paris hides from the fighting, even she despises him. When Hector, who never reproaches her, is killed, she mourns him as the only one in Troy who was ever gentle to her.\n\nAnd her ending, strangely, is peace. When Troy burned, Menelaus meant to kill her — and could not, at the sight of her. He took her home to Sparta, and there the Odyssey finds her years later, a gracious queen pouring wine and drugging away sorrow, telling stories of the war as though it had happened to other people. The face that launched a thousand ships grew old quietly, at home.",
    source: "Homer, Iliad; Homer, Odyssey."
  },
  andromache: {
    story: "Andromache had already lost almost everyone before the Iliad begins. Achilles, in an earlier raid, had killed her father and her seven brothers in a single day and taken her mother captive. All she had left in the world was Hector — husband, and in her word to him, father and mother and brother too, all of them poured into one man — and their infant son.\n\nSo when she runs to him at the Scaean Gate and pleads with him to fight from the walls, to pity her and the child, to not make her a widow and the boy an orphan, she is not being weak. She is being clear-eyed. She can already see the end. Hector cannot grant it — his honor will not let him hide — and the two of them stand there loving each other across a gap that neither can cross, while the baby cries at the flashing helmet. It is the most human moment in a poem full of gods.\n\nEverything she foresaw came true. Hector was killed by Achilles, and she learned of it not from a herald but from the wailing on the walls, and dropped the bright headdress he had given her on their wedding day. And when the city fell, the Greeks did to her exactly what such wars do to such women: her infant son was thrown from the walls so that no son of Hector might grow up to avenge Troy, and she herself was carried off across the sea as a slave in the household of the son of the man who had destroyed her whole life.\n\nShe survives, in the later tellings — endures, remarries in captivity, outlives the war. But Homer freezes her forever at the gate, reaching for her husband and her child, the truest voice in the poem for everyone the heroes leave behind.",
    source: "Homer, Iliad; Euripides, The Trojan Women."
  },
  briseis: {
    story: "Briseis says almost nothing in the Iliad, and the whole war turns on her. She had been a princess in her own right in the city of Lyrnessus, until Achilles sacked it and killed her husband and her brothers, and she was carried off to be a prize of war — a living trophy, awarded to Achilles for his valor.\n\nWhen a plague forced Agamemnon to give up his own captive girl, the high king salved his wounded pride by seizing Briseis from Achilles instead. It was a small act, casually cruel, a matter of one man's honor against another's — and it lit the fuse of the entire poem. Achilles, robbed and insulted, withdrew from the war, and thousands died in the quarrel over a woman neither man ever asked.\n\nWe are told she went unwilling, looking back. And when she returns to Achilles' tent at last, it is to find Patroclus dead — and it is over his body that she is finally allowed to speak. She weeps for him, and her grief tells us why: Patroclus, alone of all of them, had been kind to her. When Achilles had killed everyone she loved, it was Patroclus who comforted her, who promised he would make her Achilles' proper wife and not just a slave, who gave a captured woman a shred of a future to hope for. Now he too is gone.\n\nShe is the poem's quiet accusation. Fought over, seized, exchanged, never once asked — Briseis is every woman the heroes turn into a possession, and her tears for Patroclus are the war's grief spoken from the bottom of it.",
    source: "Homer, Iliad."
  },

  // ---- THE ODYSSEY ----
  penelope: {
    story: "While Odysseus wandered ten years home from a ten-year war, Penelope waited twenty in Ithaca, and hers is the harder heroism, because it had no monsters to fight — only time, and doubt, and a house full of men eating her out of her kingdom.\n\nFor Odysseus was presumed dead, and by the custom of the age a widow of property must remarry. More than a hundred suitors moved into the palace, devouring the herds, courting her by day and carousing by night, pressing her to choose one of them and be done. She could not refuse outright, and she could not say yes. So she matched her husband trick for trick.\n\nShe told them she would choose when she had finished weaving a burial shroud for old Laertes, her husband's father — a pious task none could deny her. And every day she wove at the great loom, and every night by torchlight she crept back and unpicked the day's work, so that the shroud was never finished and the choice never came. Three years the trick held, until a treacherous maid betrayed her and the suitors caught her at it.\n\nAnd when Odysseus finally came home, in beggar's rags, testing everyone before he revealed himself — she out-tested him. She would not fall on his neck on another's word. She ordered their marriage-bed moved outside the chamber, and when the stranger flared up that the bed could not be moved, for he had built it himself around a living olive tree rooted in the ground, she knew. Only her true husband knew the secret of that bed. She had laid a trap of her own, and he had walked into it, and only then did she weep and hold him. She is Odysseus's true match — not his prize, but his equal in cunning and in faith.",
    source: "Homer, Odyssey."
  },
  telemachus: {
    story: "Telemachus was a baby at his mother's breast when his father sailed for Troy, and so he grew up in a house without a father, in a kingdom slowly being eaten alive. By the time the Odyssey opens he is a young man of twenty, old enough to feel the shame of it and too green to do anything — the suitors laugh at him, drink his wine, and plot his death, and he sits among them helpless in his own hall.\n\nThe first four books of the Odyssey are his alone; the poet lets us watch a boy become a man before he lets the father come home. The goddess Athena, disguised as an old family friend named Mentor, comes to stiffen his spine and send him out into the world to seek news of his father — and simply by leaving, by daring the sea and standing in the courts of Nestor and Menelaus and asking his question like a man, he grows into himself. He learns his father is alive. More important, he learns that he is his father's son.\n\nWhen at last Odysseus returns in disguise, it is to Telemachus he first reveals himself, and the two of them weep together and then, heads bent, plot the killing of the suitors like partners. In the great slaughter in the hall, Telemachus fights at his father's side, guards the doors, takes his share of the danger and the blood. He has become, at last, worthy of the name.\n\nHis is the quieter journey inside the great one — not a hero's voyage among witches and monsters, but the ordinary, universal one: a fatherless boy learning who he is, and going to find the man he came from.",
    source: "Homer, Odyssey."
  },
  nausicaa: {
    story: "Of all the people Odysseus meets on his long way home, Nausicaa is the one the reader most wishes he could have stayed with — and the poem knows it, and gently will not allow it.\n\nHe washes up on the shore of the Phaeacians as low as a man can be: shipwrecked, naked, salt-crusted, having lost every ship and every companion, asleep in a drift of leaves. And into that morning comes a girl, a princess, sent by a dream to wash the palace linen at the river with her maids. When the wild, brine-caked stranger lurches out of the bushes, the maids scream and scatter — but Nausicaa, alone, plants her feet and stands. Athena had put courage in her heart. She gives the beggar clothes, and food, and oil to clean himself, and speaks to him with a grace and tact beyond her years.\n\nAnd she likes him. Homer lets us see it, tenderly and without mockery — the young princess half in love, thinking to her maids that she could wish for just such a man to be her husband, and quietly hoping the gods might arrange it. She tells him how to approach her parents' court, coaches him in the customs, all but leads him to the door of the home that could be his.\n\nBut Odysseus's heart is in Ithaca, with a wife he has not seen in twenty years, and both of them come to understand it. There is no scene, no rejection, no cruelty. When he is leaving, she stands quietly by a pillar and says only: farewell, stranger — and remember me sometimes, for you owe your life to me first. And he promises he will pray to her all his days as to a god. It is one of the most graceful partings in all of literature: a first love given up with dignity by both, and remembered the more for never having been.",
    source: "Homer, Odyssey."
  },

  // ---- THE HOUSE OF HELIOS — CIRCE'S KIN & HEIRS ----
  perse: {
    story: "Before there were witches, there was a marriage of fire and salt water. Helios the sun took to his golden halls an Oceanid named Perse — a daughter of the deep, cold and lovely and vain — and of that union came four children the like of which the world had never seen.\n\nThe old poets give Perse almost nothing: a name, a lineage, a single startling line that she and Helios were the parents of Circe and Aeëtes, of Pasiphaë and Perses. But that line is a door into something strange, for every one of her children was a worker of pharmaka, of true drug-craft and transformation — the first mortals or immortals to bend the herbs of the earth to their will. Whatever it was that ran in that blood, it came down from the marriage of the sun and the sea, and Perse carried half of it.\n\nShe was no nurturer. In the telling she cares for her own beauty and the glitter of her husband's court, and looks on her uncanny brood with distaste, as one might regard something that has crawled up cold and pale from the tide. And perhaps that is fitting. The children of Helios and Perse would each go out into the world to make it more dangerous — a witch on a lonely island, a sorcerer-king guarding a golden fleece, a queen who bore a monster, a necromancer among the dead — and their mother, having given them the sea's cold gift, simply turned back to her mirror.",
    source: "Hesiod, Theogony; Homer, Odyssey."
  },
  pasiphae: {
    story: "She was a daughter of the sun, and she married a son of Zeus, and it should have been the brightest house in the world. Instead it became the most cursed. Pasiphaë, sister to the witch Circe, went as a bride to King Minos of Crete — and there her blood, thick with the sorcery of Helios's line, curdled into something terrible.\n\nMinos had prayed to Poseidon for a sign of favor, and the sea-god sent up a bull of dazzling white, on the understanding it would be sacrificed back to him. But the beast was too beautiful; Minos kept it and killed a lesser bull in its place. Gods do not forgive such theft. Poseidon's revenge fell not on the king but on his wife: he filled Pasiphaë with a consuming, unnatural passion for the white bull.\n\nMaddened, she went to the great craftsman Daedalus, then a guest in Crete, and had him build a hollow wooden cow, cunningly hidden, in which she might approach the animal. And so she conceived and bore the Minotaur — Asterion, a child with the body of a man and the head of a bull, who could stomach no food but human flesh. Her husband, sick with shame, had Daedalus raise the Labyrinth to hide the thing away, and fed it on tribute.\n\nBut do not think her only a victim of the curse. Pasiphaë was a witch to her marrow, cold and cruel and clever, mother also of Ariadne and Phaedra, and she ruled Crete with poison at her fingertips. In her sister Circe's memory she is the sharp-tongued, glittering one — the queen who summoned Circe across the sea to midwife the monster, and never once said thank you.",
    beats: [
      { label: "Daughter of the Sun", weight: 1, figures: ['helios', 'circe'],
        text: "Pasiphaë, daughter of Helios and sister to the witch Circe, went as a bride to King Minos of Crete — and there her blood, thick with the sorcery of the sun's line, curdled into something terrible." },
      { label: "The White Bull", weight: 0.85, figures: ['minos', 'poseidon'],
        text: "Minos prayed for a sign, and Poseidon sent up a dazzling white bull to be sacrificed. But the beast was too beautiful; the king kept it and killed a lesser bull instead. Gods do not forgive such theft." },
      { label: "The Curse", weight: 0.9,
        text: "Poseidon's revenge fell not on the king but on his wife: he filled Pasiphaë with a consuming, unnatural passion for the white bull." },
      { label: "The Wooden Cow", weight: 0.8, figures: ['daedalus'],
        text: "Maddened, she went to the craftsman Daedalus and had him build a hollow wooden cow in which she might approach the animal." },
      { label: "The Minotaur", weight: 0.95, figures: ['minotaur'],
        text: "And so she conceived and bore the Minotaur — a child with the body of a man and the head of a bull, who could stomach no food but human flesh, and who was hidden away in the Labyrinth and fed on tribute." },
      { label: "The Witch-Queen", weight: 0.75, figures: ['ariadne'],
        text: "Yet she was no mere victim — a witch to her marrow, cold and clever, mother also of Ariadne, ruling Crete with poison at her fingertips: the queen who summoned Circe across the sea to midwife the monster, and never once said thank you." },
    ],
    source: "Apollodorus, Library; Ovid, Metamorphoses."
  },
  minos: {
    story: "Minos was the greatest king the islands had ever known — son of Zeus and Europa, lord of Crete, master of a fleet that swept the pirates from the sea and made his name a byword for law. It was said Zeus himself tutored him in kingship, and that every nine years Minos climbed to a sacred cave to receive the divine ordinances afresh. No mortal was more just. No mortal's house was more accursed.\n\nHis ruin was a single act of greed. Poseidon sent him a white bull from the sea as a sign of his right to rule, and Minos, dazzled, kept it rather than giving it back in sacrifice. The sea-god's revenge worked through the king's own wife, Pasiphaë, who bore the bull-headed Minotaur; and Minos, to bury the shame, commanded Daedalus to build the Labyrinth and shut the monster inside.\n\nTo feed it he laid a grief on Athens: every year (or every nine), youths and maidens sent as tribute, driven into the maze to be devoured — until the hero Theseus came with the tribute, and with the help of Minos's own daughter Ariadne, killed the thing and found his way out again by her thread. When Daedalus was found to have given away the maze's secret, Minos imprisoned the craftsman too; and Daedalus escaped him on wings, and Minos, hunting him across the world, met his death far from home in a scalding bath.\n\nAnd yet so profound was his sense of justice that the gods would not let it end there. They made Minos one of the three judges of the dead, weighing in the underworld the souls of all who came — a king whose own life had been broken by a curse, set to render perfect judgment forever.",
    source: "Apollodorus, Library; Homer, Odyssey; Virgil, Aeneid."
  },
  aeetes: {
    story: "At the far eastern edge of the world, where Helios stables his horses and the dawn first touches the water, stood the kingdom of Colchis — and its king was Aeëtes, son of the sun and brother to the witch Circe. Like all the children of that house he was a worker of dark sorcery, proud and hawk-eyed and pitiless, and in his sacred grove he kept the wonder of the age: the Golden Fleece, hung on an oak and guarded by a dragon that never slept.\n\nWhen Jason and his Argonauts came for the Fleece, Aeëtes did not refuse them outright — he set them a task he thought no man could survive. Yoke my fire-breathing bulls, he said, plow the field of Ares, sow it with a dragon's teeth, and cut down the armed men that spring up from the furrows. It would have been Jason's death. It was, instead, the beginning of Aeëtes's undoing, for the king had a daughter.\n\nMedea, his own child and a sorceress to rival any, fell in love with the stranger and betrayed her father utterly. She gave Jason an ointment against the bulls' fire, taught him the trick of the sown men, and drugged the sleepless dragon so that Jason could lift the Fleece and flee. When Aeëtes gave chase, Medea murdered her own brother and scattered him piece by piece across the waves, so that her grieving father would have to stop and gather the boy for burial.\n\nSo the witch-king lost everything — the Fleece, his daughter, his son, his very throne, which his brother Perses seized in the ruin. He was a hard man and a cruel one, and the myth does not much mourn him; but there is a bleakness in his story that his sister Circe understood, alone on her own island: the children of Helios burn bright and cold, and they are very hard to love.",
    source: "Apollonius of Rhodes, Argonautica; Hesiod, Theogony."
  },
  perses: {
    story: "Of the four children of Helios and Perse, three blaze in the old stories — Circe on her island, Aeëtes with his Fleece, Pasiphaë and her monster. The fourth, Perses, moves almost entirely in shadow, and that is fitting, for what little is told of him is dark.\n\nHe was a sorcerer like his siblings, but where Circe worked her craft on beasts and Aeëtes on the guarding of treasure, Perses is remembered for turning east and downward, toward death — a worker of necromancy, a raiser and questioner of the dead. Ambitious and treacherous, he wrested the kingdom of Colchis from his brother Aeëtes by force, and for a time the usurper sat the witch-king's throne.\n\nBut this house does not forgive betrayal from within, and its avenger was Medea. Aeëtes's daughter, exiled and infamous after the ruin of Jason's marriage, came home at last to find her father overthrown by her uncle. She dealt with Perses as she dealt with all her enemies — by poison, some say, or by the knife — and restored Aeëtes, or seized the throne for her own son. Either way, Perses died as he had lived, in the family's endless coil of sorcery and blood.\n\nHe is the least of Helios's children, and the most purely sinister: proof that the sun's cold gift, in a mind without Circe's slow-won mercy or even Aeëtes's kingly pride, curdled simply into hunger for power over the grave.",
    source: "Apollodorus, Library; Hesiod, Theogony."
  },
  telegonus: {
    story: "When Odysseus came at last to the island of Aeaea, he stayed a year in the bed of the witch Circe before he sailed on toward Ithaca and his patient wife. He never knew that he left a child behind him. Circe bore a son alone on her island and named him Telegonus — 'born far away' — and raised him with all a goddess's care in a place where nothing could touch him.\n\nBut a boy cannot grow up on the edge of the world forever, and Telegonus burned to find the father he had never seen. Against his mother's fear he built a ship and sailed for Ithaca. His mother, who could read the threads of fate, dreaded what she could not prevent, and armed him as best she could — with a spear whose point was the venomed sting of Trygon, the great ray of the abyss, a weapon against which no healing could stand. She meant it for his protection. It became the instrument of the prophecy.\n\nFor when Telegonus landed, storm-driven and hungry, he did not know the shore was Ithaca, and when men came against him to drive off the raiders he took them for, he fought. An old warrior led them, fierce despite his years — and Telegonus struck him down with the stingray spear. Only as the old man lay dying did the two of them learn the truth: the young stranger was Odysseus's son, and Odysseus was the father he had crossed the sea to find. The oracle had foretold it long ago — that death would come to Odysseus 'from the sea,' gentle and strange. It came from his own unknowing child, on a barb drawn up from the deepest water.\n\nGrief-stricken, Telegonus carried his father's body home to Circe, and with it Odysseus's widow Penelope and his son Telemachus. And there, at the story's quiet end, the two houses folded together on the witch's island — the son of the sea and the son of Ithaca, the faithful wife and the immortal witch — mortals and a goddess trying, after so much loss, simply to live.",
    beats: [
      { label: "A Child Left Behind", weight: 1, figures: ['circe', 'odysseus'],
        text: "Odysseus stayed a year with the witch Circe before sailing home, never knowing he left a child behind him. Circe bore a son alone on Aeaea and named him Telegonus — 'born far away.'" },
      { label: "The Voyage Out", weight: 0.8,
        text: "A boy cannot grow up on the edge of the world forever. Telegonus burned to find the father he had never seen, and against his mother's fear he built a ship and sailed for Ithaca." },
      { label: "The Venomed Spear", weight: 0.85, figures: ['trygon'],
        text: "Circe, who could read the threads of fate, armed him with a spear whose point was the venomed sting of Trygon, the great ray of the abyss — meant for his protection. It became the instrument of the prophecy." },
      { label: "Death from the Sea", weight: 0.95,
        text: "Landing unknowing on Ithaca, Telegonus fought the men who came against him and struck down their old leader with the stingray spear — learning only as the man lay dying that he had killed Odysseus, the very father he had crossed the sea to find." },
      { label: "The Houses Folded Together", weight: 0.75, figures: ['penelope', 'telemachus'],
        text: "Grief-stricken, he carried his father home to Circe, and with him Penelope and Telemachus — and there the two houses folded together on the witch's island, mortals and a goddess trying, after so much loss, simply to live." },
    ],
    source: "Eugammon of Cyrene, Telegony; Apollodorus, Epitome."
  },
  trygon: {
    story: "Not everything in the sea belongs to Poseidon. Beneath the reach of the tides, below the last thread of the sun's light, in water so deep and so old that it predates the reign of the Olympians, there dwells a being the newer gods do not command: Trygon, the great ray of the abyss.\n\nIts body is broad and flat and dark as the water around it, and its long tail carries a barbed sting whose venom is beyond any cure — not a poison to be survived and recovered from, but a wound that simply, slowly, cannot be closed. To seek Trygon out one must go down into the black and the cold and the crushing silence, past every warm and living thing, and ask; and the asking has a price.\n\nFor from that living sting was cut the point of a single spear — the weapon that a witch gave to her son for his protection, and that the son, all unknowing, drove into the body of his own father, the wanderer Odysseus. So the deepest and most ancient creature of the sea reached up, through a chain of love and fear and accident, to fulfill an oracle spoken years before: that death would come to Odysseus out of the water.\n\nTrygon does not hate, and does not hunt the affairs of gods and men. It is simply there, at the bottom of everything, patient and immense and cold — the old, indifferent depth from which grief can always be drawn, if one is willing to go far enough down to find it.",
    source: "Eugammon of Cyrene, Telegony (and later tradition)."
  }
};
