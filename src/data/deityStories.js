...
export const deityStories = {
  ...
  persephone: {
    story: "Persephone is the maiden of spring who became the queen of the dead — two goddesses in a single body, the girl gathering flowers in the sun and the dread sovereign of the world below. Daughter of Demeter and Zeus, she was called Kore in her innocence, the bright daughter around whom the whole green world turned.\n\nShe was a girl in a meadow, reaching for a strange and beautiful narcissus that the earth had put forth as a lure, when the ground tore open beneath her and Hades surged up in his dark chariot and seized her, dragging her down before she could so much as cry out. Below, the frightened girl found herself queen of a silent kingdom, and slowly, terribly, she grew into the role — learning the weight of the crown and the cold patience that ruling the dead demands.\n\nIn her grief she ate six small seeds of a pomegranate, and that taste of the food of the dead bound her to the shadows forever after. So a bargain was struck: she rises each spring to walk the earth at her mother\'s side, and the world breaks into flower at her coming; each autumn she descends again to her cold throne, and the world withers behind her. The turning between the two is the turning of the year itself.\n\nIn time she became not merely Hades\' consort but a judge of the dead in her own right, weighing the lives that streamed endlessly through the gates. And when the singer Orpheus came down alive to beg for his wife, it was Persephone who wept at the beauty of his song — and Persephone, clear-eyed, who imposed the fatal condition: walk ahead, never look back. She knew what love would do.",
    beats: [
