...
export const deityStories = {
  ...
  prometheus: {
    story: "Prometheus — his name means \'forethought\' — was the son of the Titan Iapetus and the wisest of all the elder gods, the one who could see what was coming before it arrived. While his brothers warred or shouldered the sky, he turned his quick mind toward the small, shivering, short-lived creatures of the dust — humankind — and could not bear to leave them naked in the cold.\n\nSome say it was Prometheus himself who shaped the first men from river-clay, moulding them upright so they would look at the stars instead of the ground, breathing into them a spark of the divine reason that only the gods had known. Whether he made them or merely pitied them, he became their champion from the start, and the price of that love would be terrible.\n\nAt the great feast of Mekone, where gods and mortals sat together for the last time, Prometheus divided a slaughtered ox into two portions: one of good meat hidden beneath the stomach-lining, the other of bare bones dressed in glistening white fat. He invited Zeus to choose, and the king of heaven, deceived by the gleam, took the bones. So the pattern of sacrifice was set forever — the savor of burnt fat for the gods, the nourishing flesh for men — and Zeus, who does not forgive a trick, hid fire away from the world in revenge.\n\nBut Prometheus stole it back, carrying a single live ember down from heaven concealed in the pith of a hollow fennel-stalk, and placed it in mortal hands. With fire came everything — warmth, the forge, the kiln, the cooked meal, the lit hearth around which language and law could grow. For that theft Zeus had him seized and chained to a crag high in the Caucasus, where each dawn a great eagle descended to tear out his liver, and each night the liver grew whole again, so that the punishment could begin fresh with the morning — an agony built to have no ending.\n\nNor was Zeus satisfied with punishing the thief alone. He ordered Hephaestus to fashion a woman out of clay, dressed her in beauty and cunning, and sent her down to Prometheus\'s trusting brother Epimetheus as a gift: Pandora, who carried with her a sealed jar. When the lid was lifted, every sorrow that men had never known came swarming into the world — disease, old age, toil, and grief — and only blind Hope remained, crouching beneath the rim.\n\nSo Prometheus hung for an age of the world, alone on his rock above the clouds, until Heracles passed beneath the cliff on one of his labors, saw the eagle descending, lifted his bow, and shot it out of the sky. He struck the chains from the Titan\'s wrists, and Prometheus stood upright again at last — the friend of mortals, scarred but unbroken, who had given men everything and asked for nothing in return.",
    beats: [
  ...
  medusa: {
    story: "Medusa was not always a monster. Before the serpents and the stone-turning gaze, she was a maiden of surpassing beauty — hair like dark water flowing, a face that drew suitors from every shore. Of the three Gorgon sisters she alone was mortal, and she alone had once been loved for her loveliness rather than feared for her horror.\n\nHer ruin began with the sea-god Poseidon, who desired her and would not be refused. He took her by force in the marble temple of Athena herself, coupling with her upon the cold floor before the goddess\'s own altar. Athena, outraged at the defilement of her sanctuary but unwilling — or unable — to punish a fellow Olympian, turned the full weight of her anger upon the girl instead. She twisted Medusa\'s glorious hair into a nest of living serpents, hardened her features into a mask of such primal terror that any living creature who met her eyes was turned instantly to cold grey stone.\n\nSo Medusa was driven to the farthest rim of the world, past the country of the Graeae, past the edges of any map, to a desolate shore littered with the petrified shapes of men and beasts who had stumbled upon her and looked one moment too long. There she dwelt among her immortal sisters Stheno and Euryale, a mortal exile in a kingdom of statues, and no living thing came near her that did not become stone.\n\nIt was the hero Perseus who was sent to end her. Armed by the gods — winged sandals from Hermes, a mirror-bright shield from Athena, the cap of invisibility from the nymphs — he crept into the Gorgons\' lair while they slept, and guided his sword-stroke by the reflection in his polished bronze, never once meeting her eyes directly. The blade fell, and as Medusa\'s head left her shoulders, two wonders sprang from the blood of her severed neck: the winged horse Pegasus, white and shining, and the golden warrior Chrysaor — beauty and valor leaping free of her ruin at the very last, children of Poseidon who had waited within her all along.\n\nBut even in death Medusa\'s power did not fade. Perseus carried her head in a leather sack across the world, turning enemies to stone with a single unveiling, and at the last he gave it to Athena, who set it upon her aegis — the goddess\'s own breastplate and shield. So the face that had been made monstrous as a punishment became the most terrible weapon in heaven\'s arsenal, and Medusa stares out from the center of Athena\'s armor still: powerful even in death, and perhaps more terrible than she ever was in life.",
    beats: [
